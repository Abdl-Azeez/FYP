    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      ...
      <div class='collapse navbar-collapse' id='navbarNav'>
        <ul class='ul-class nav navbar-nav borderEffect'>
         ...
         <li class='activated'><a href='\fyp\Admin\AllRecords.php' style='color: #121307;'>Records</a></li>
      ...
      <div style="display: flex;justify-content: space-around;width: 100%;margin-top: 50px;">
        ...
        <?php
          ...
          $sql= "SELECT request.Id, request.StaffName, request.StaffID, request.leaveType, request.DateFrom, request.DateTo, request.Attachment, request.PostingDate, request.Position, request.status,
           users.ELtaken, users.ELbalance, users.CLtaken, users.CLbalance, users.Annualtaken, users.Annualbalance, users.OLtaken, users.OLbalance FROM request INNER JOIN users ON users.Department = request.Departments WHERE users.StaffName = request.StaffName AND request.status>$status AND request.status!=3
              ...
              echo"
                      <tbody>
                        <tr>
                          ...
                          <td style='width: 120px;'>$myrow[5]</td>
