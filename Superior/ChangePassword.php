    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      <div class='logo'>
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
          ...
          <li class='activated'><a href='\fyp\Superior\ChangePassword.php' style='color: #121307;'>Change Password</a></li>
          <li class='nav-item' style='display:none;'><a href='\fyp\Logout.php'>Logout</a></li>
        </ul>
			</div>
  ...
  function UpdatePass()
  {
     ...
     var r = confirm("You are about to update your password\n Press OK to proceed \nCANCEL to terminate the process");
      if (r == true) {
        ...
        ({
            type:'post',
            url:'/FYP/Superior/UpdatePass.php',
            data:{
