    ...
    <navigation  class='fixed-top navbar navbar-expand-lg navbar-dark nav-style'>
      <div class='logo'>
        ...
        <ul class='ul-class nav navbar-nav borderEffect'>
         <li class='nav-item'><a href='\fyp\Superior\Records.php' style='padding-left:8px;' class="ml-2">Staff Requests</a></li>
         <li class='nav-item'><a href='\fyp\Superior\StaffRecords.php'>Records</a></li>
         <li class='activated'><a href='\fyp\Superior\Profile.php' style='color: #121307;'>View Profile</a></li>
        ...
        echo "
          <form id=\"Profile\" enctype=\"multipart/form-data\" class='profileSection' method='post' action=\"#\" onsubmit=\"return Profile();\">
            ...
            <div class='profilePicture'>
              <a href=\"";if ($myrow[22]==""){echo "\FYP\images\userPlaceholder.png";}else{echo"\FYP\Superior\ProfilePictures\\$myrow[22]";};echo"\" target=\"_blank\">
                <img src='";if ($myrow[22]==""){echo "\FYP\images\userPlaceholder.png";}else{echo"\FYP\Superior\ProfilePictures\\$myrow[22]";};echo"'/>
              </a>
            ...
            <div class='sideform'>
              ...
              <div class='form-group'>
                ...
                <input type='text' name='Username' id='Username' value='$myrow[2]' pattern=\"^[a-zA-Z][a-zA-Z0-9-_\/.]{1,20}$\" title=\"username should not contain any space\" required readonly>
              </div>
              <div class='form-group'>
...
<script type="text/javascript">
  function rowdel(){
    if(confirm("Are you sure you want to remove your profile picture?")){
      ...
      ({
          type:'post',
          url:'/FYP/Superior/Picturedel.php?empid=<?php echo "$myrow[0]";?>',
          data:{
  ...
  function Profile()
  {
     ...
     var r = confirm("You are about to update your profile\n Press OK to proceed \nCANCEL to terminate the process");
      if (r == true) {
        ...
        ({
            type:'post',
            url:'/FYP/Superior/UpdateProfile.php',
            data:formdata,
            contentType: false,
            processData: false,
            success: function (response) {
