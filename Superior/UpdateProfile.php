<?php
  ...
  if (isset ($_POST['UpdateProfile'])){
    ...
    if(empty($errors)==true){
  	...
  	$sql="UPDATE users SET StaffID = '$StaffID' , Username= '$Username' , Profileimg ='$file_name', Email ='$Email', StaffName= '$Full_Name', MobileNum= '$Mobile', Gender= '$Gender' WHERE username='$user' AND roles='Superior'";
